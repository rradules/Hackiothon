...
public class HumidityGraphFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstance)
    {
        ...
        frameLayout = (FrameLayout) getActivity().findViewById(R.id.humiditygraph);

    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        super.onCreateView(inflater, container, savedInstanceState);
        this.setRetainInstance(true); // So we don't reload on orientation
        View rootView = inflater.inflate(R.layout.fragment_humiditygraph, container, false);
    ...
    private class AsyncGetTemperature extends AsyncTask<String, Void, SensorResponse> {
        ...
        private String jsonSensorData = "http://www.nassist-test.com/api/sensors/4Noks_77000000-0000-0000-0000-000000000077_ZED_THL_16_Humidity_8/values?format=json&";
        ...
        private void SetTemperatureChart(SensorResponse data) {
            ...
            //graphView.setBackground(new ColorDrawable(R.color.vubdark));
            FrameLayout layout = (FrameLayout) getActivity().findViewById(R.id.humiditygraph);
            layout.addView(graphView);
            TextView dummyTextView = (TextView) getActivity().findViewById(R.id.section_label2);
