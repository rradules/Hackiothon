...
public class TemperatureGraphFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstance)
    {
        ...
        frameLayout = (FrameLayout) getActivity().findViewById(R.id.fragmentgraph);

    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        setRetainInstance(true); // So we don't reload on orientation
        View rootView = inflater.inflate(R.layout.fragment_temperaturegraph, container, false);
    ...
    private class AsyncGetTemperature extends AsyncTask<String, Void, SensorResponse> {
        ...
        private String jsonSensorData = "http://www.nassist-test.com/api/sensors/4Noks_77000000-0000-0000-0000-000000000077_ZED_THL_16_Temperature_6/values?format=json&";
        ...
        private void SetTemperatureChart(SensorResponse data) {
            ...
            FrameLayout layout = (FrameLayout) getActivity().findViewById(R.id.fragmentgraph);
            layout.addView(graphView);

            TextView dummyTextView = (TextView) getActivity().findViewById(R.id.section_label);
